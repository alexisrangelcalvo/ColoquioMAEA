...
<div style="text-align: justify">*¿Hay alguna de estas variables (edad, estado civil, el comportamiento crediticio mes con mes) que pueda explicar el por qué algunos clientes tienen mucho más limite crediticio que otros? ¿Se puede modelar una aproximación a dicha relación?*<div/>
<Hr>
...
<div style="text-align: justify">Encontrar la relación de las variables que disponemos para cada cliente, con su limite crediticio. <div/>
<Hr>
...
```{r, include=FALSE}
ggagebp = ggplot(df0) +
  geom_boxplot(mapping = aes(x=MARRIAGE, y = LIMIT_BAL, fill=SEX))+ theme(plot.title=element_text(size=10))+
 ggtitle("Distribución del crédito máximo por estado civil y sexo")
gglimbp = ggplot(df0) +
...
**¿Qué porcentaje de la muestra representa cada grupo educación-estado civil?**
```{r, echo=FALSE}
propGlob_f
```
...
```{r fig.asp = 3/4, fig.align = 'center', echo = FALSE, out.width = "100%", dpi= 300, warning = FALSE}
gglimbp2 =  ggplot(net_differences_bymonths, mapping = aes(x=CLIENT_PROFILE, y = LIMIT_BAL, fill=SEX)) +
  geom_boxplot()+
  ...
  ggtitle("Distribución del limite crediticio por perfil del cliente y por sexo (con media y conteo)")
...
```{r fig.asp = 3/4, fig.align = 'center', echo = FALSE, out.width = "100%", dpi= 300, warning = FALSE}
gglimbp3 = ggplot(net_differences_bymonths, mapping = aes(x=CLIENT_PROFILE, y = LIMIT_BAL, fill=EDUCATION)) +
  geom_boxplot()+
  stat_summary(fun= "mean", geom = "point", shape = 23, size = 3, fill = "white")+
  annotate("text",
           x = 1:length(table(net_differences_bymonths$CLIENT_PROFILE)),
...
```{r fig.asp = 3/4, fig.align = 'center', echo = FALSE, out.width = "100%", dpi= 300, warning = FALSE}
gglimbp3 = ggplot(net_differences_bymonths, mapping = aes(x=CLIENT_PROFILE, y = LIMIT_BAL, fill=MARRIAGE))+
  geom_boxplot()+
  stat_summary(fun= "mean", geom = "point", shape = 23, size = 3, fill = "white")+
  annotate("text",
           x = 1:length(table(net_differences_bymonths$CLIENT_PROFILE)),
  ...
  ggtitle("Distribución del limite crediticio por perfil del cliente y por estado civil")
gglimbp3
```
